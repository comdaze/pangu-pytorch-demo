...
def process_month(select_month):
    ...
    msl_ds = xarray.open_dataset(
        f'nsf-ncar-era5/e5.oper.an.sfc/{select_month}/e5.oper.an.sfc.128_151_msl.ll025sc.{select_month}0100_{select_month}{select_month_end}23.nc')
    u10_ds = xarray.open_dataset(
        f'nsf-ncar-era5/e5.oper.an.sfc/{select_month}/e5.oper.an.sfc.128_165_10u.ll025sc.{select_month}0100_{select_month}{select_month_end}23.nc')
    v10_ds = xarray.open_dataset(
        f'nsf-ncar-era5/e5.oper.an.sfc/{select_month}/e5.oper.an.sfc.128_166_10v.ll025sc.{select_month}0100_{select_month}{select_month_end}23.nc')
    t2m_ds = xarray.open_dataset(
        f'nsf-ncar-era5/e5.oper.an.sfc/{select_month}/e5.oper.an.sfc.128_167_2t.ll025sc.{select_month}0100_{select_month}{select_month_end}23.nc')
...
def process_date(select_date):
    ...
    z_ds = xarray.open_dataset(
        f'nsf-ncar-era5/e5.oper.an.pl/{select_month}/e5.oper.an.pl.128_129_z.ll025sc.{select_date}00_{select_date}23.nc')
    q_ds = xarray.open_dataset(
        f'nsf-ncar-era5/e5.oper.an.pl/{select_month}/e5.oper.an.pl.128_133_q.ll025sc.{select_date}00_{select_date}23.nc')
    t_ds = xarray.open_dataset(
        f'nsf-ncar-era5/e5.oper.an.pl/{select_month}/e5.oper.an.pl.128_130_t.ll025sc.{select_date}00_{select_date}23.nc')
    u_ds = xarray.open_dataset(
        f'nsf-ncar-era5/e5.oper.an.pl/{select_month}/e5.oper.an.pl.128_131_u.ll025uv.{select_date}00_{select_date}23.nc')
    v_ds = xarray.open_dataset(
        f'nsf-ncar-era5/e5.oper.an.pl/{select_month}/e5.oper.an.pl.128_132_v.ll025uv.{select_date}00_{select_date}23.nc')
