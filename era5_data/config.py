...
__C.PG.TRAIN.START_TIME = '20150101 12:00:00'
...
__C.PG.TRAIN.EARLY_STOP = 10  # default: 5

__C.PG.VAL = edict()
__C.PG.VAL.START_TIME = '20230101 12:00:00'
__C.PG.VAL.END_TIME = '20240101 12:00:00'
...
__C.PG.TEST.FREQUENCY = '24h'  # default: 12h (HORIZON=24)
