...
# horizon = 1
for onnx_model_path, horizon in tqdm([(cfg.PG.BENCHMARK.PRETRAIN_24, 24), (cfg.PG.BENCHMARK.PRETRAIN_6, 6), (cfg.PG.BENCHMARK.PRETRAIN_3, 3), (cfg.PG.BENCHMARK.PRETRAIN_1, 1)]):
